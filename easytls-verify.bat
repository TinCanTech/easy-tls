...
sh.exe easytls-verify.sh %VERB% -c=%CA_DIR% %TMP_DIR% %PID_FILE% >> %LOG% 2>&1
...
REM missing value to optionmissing value to option
IF ERRORLEVEL 6 SET SH_EXIT=7
REM missing X509 client cert serial
IF ERRORLEVEL 6 SET SH_EXIT=8
REM other error
